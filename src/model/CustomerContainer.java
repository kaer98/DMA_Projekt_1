...
public class CustomerContainer {
	...
	public void fill() {
		addNewCustomer("Jens", "12345678", "jens0@ucn.dk", "Danmark", "9000", "Aalborg", "Jens vej 1", "11111111",
				0.10);
		addNewCustomer("Jonas", "88888888", "jonas@ucn.dk", "Danmark", "8000", "København", "Jonas vej 2", "22222222",
				0.20);
		addNewCustomer("Jeppe", "11111111", "jeppe@ucn.dk", "Danmark", "7000", "Odense", "Jeppe vej 3", "33333333",
				0.50);
		...
		addNewCustomer("Christian", "77777777", "christian@ucn.dk", "Danmark", "7777", "Århus", "Christian vej 7",
				"66666666", 0.15);
		addNewCustomer("Michael", "81818181", "michael@ucn.dk", "Danmark", "8111", "Brovst", "Michael vej 8",
				"77777777", 0.22);
		addNewCustomer("Ole", "88888888", "ole@ucn.dk", "Danmark", "1000", "Skagen", "Ole vej 9", "98765432", 0.40);
		addNewCustomer("Thomas", "55555555", "thomas@ucn.dk", "Danmark", "5000", "Middelfart", "Thomas vej 5",
				"55555555", 0.23);
